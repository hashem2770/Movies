...
import 'package:movie_getx/Controllers/PlayingNow-Controller.dart';
...
class PlayingNow extends StatelessWidget {
  final PlayingNowController playingNowController = Get.put(PlayingNowController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<PlayingNowController>(
        builder: (controller) =>
            FutureBuilder<Movies>(
              future: controller.playingNowMovies,
